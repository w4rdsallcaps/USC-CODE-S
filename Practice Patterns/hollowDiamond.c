...
int main()
{
    ...
    //Loop for a Hollow Diamond pattern: Upper Portion
    for(row = 1; row <= nth; row++)
    {
        //First Half: Upper Portion
        for(column = nth; column >= 1; column--)
        {
            if(column == row)
            {
                printf("*");
        ...
        for(column = 2; column <= nth; column++)
        {
            if (column == row)
            {
                printf("*");
    ...
    //Loop for a Hollow Diamond pattern: Lower Portion
